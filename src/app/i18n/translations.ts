...
const en = {
  ...
  front: {
    ...
    motto: "All the music that's fit to print.",
  ...
  about: {
    ...
    bio3: "Born in Lebanon, he left at seventeen for physics and mathematics — first in France, then Belgium — before abandoning the sciences for music outright in 2026. He now reads composition at the Sorbonne in Paris.",
    bio5: "Physics and music never felt like opposite poles to him: both ask you to hear a structure before you can prove it, and for years the discipline of one fed the other before he finally chose between them.",
    bio6: "What he writes ranges from solo lines to large-ensemble and choral works, and the hours not spent on his own scores go to the archive work that has become a second calling.",
  ...
  services: {
    lede: "Most of what arrives at this desk is collaborative: a conductor with a programme to fill, an ensemble between commissions, a publisher with a manuscript in need of a clean edition. The work below is offered in that spirit — practical, made to order, and shaped around the people who will perform it.",
    dept: "Notices",
    headline: "Composer Offers His Services",
    deck: "Commissions, engraving, orchestration and teaching — placed at the disposal of performers and institutions.",
  ...
  contact: {
    ...
    deck: "The desk is open to performers, ensembles and institutions — and the merely curious.",
    byline: "From the Editor's Desk",
    title: "Contact",
    eyebrow: "A note from the composer",
    salutation: "Dear reader,",
    p1: "I am always glad to hear from performers, ensembles and institutions in search of new work — whether that means an original score or the revival of music unfairly forgotten.",
  ...
  book: {
    ...
    p1: "Lili Boulanger (1893–1918) was the first woman to win the Prix de Rome, and yet a century on much of her music still has no proper modern edition — some of it was never formally published at all. Her manuscripts lie scattered across archives, waiting to be heard as she intended.",
  ...
  rack: {
    review: "The pieces gathered here range from solo lines to large-ensemble and choral writing, each entered into the catalogue as it is finished. What follows is the standing record; the full holdings run longer.",
    dept: "The Arts · Review",
    headline: "Composer Unveils a Season of New Works",
    deck: "Selected compositions for soloists, chamber forces, choir and orchestra — entered into the record.",
...
const fr: Dict = {
  ...
  front: {
    ...
    motto: "Toute la musique digne d'être imprimée.",
  ...
  about: {
    ...
    bio3: "Né au Liban, il le quitte à dix-sept ans pour la physique et les mathématiques — en France, puis en Belgique — avant d'abandonner les sciences pour la musique en 2026. Il étudie aujourd'hui la composition à la Sorbonne, à Paris.",
    bio5: "La physique et la musique ne lui ont jamais semblé opposées : l'une comme l'autre demandent d'entendre une structure avant de pouvoir la démontrer, et la discipline de la première a longtemps nourri la seconde, avant qu'il ne tranche.",
    bio6: "Son écriture va de la ligne soliste aux grandes pages d'ensemble et de chœur, et les heures qu'il ne consacre pas à ses propres partitions vont au travail d'archive devenu une seconde vocation.",
  ...
  services: {
    lede: "L'essentiel de ce qui parvient à ce bureau relève de la collaboration : un chef à la recherche d'une œuvre, un ensemble entre deux commandes, un éditeur dont le manuscrit réclame une édition propre. Les prestations ci-dessous sont proposées dans cet esprit — concrètes, sur mesure, et pensées pour ceux qui les joueront.",
    dept: "Annonces",
    headline: "Le compositeur propose ses services",
    deck: "Commandes, gravure, orchestration et enseignement — au service des interprètes et des institutions.",
  ...
  contact: {
    ...
    deck: "Le bureau est ouvert aux interprètes, aux ensembles, aux institutions — et aux simples curieux.",
    byline: "Le bureau de la rédaction",
    title: "Contact",
    eyebrow: "Un mot du compositeur",
    salutation: "Cher lecteur,",
    p1: "Je suis toujours heureux d'avoir des nouvelles d'interprètes, d'ensembles et d'institutions en quête d'œuvres nouvelles — qu'il s'agisse d'une partition originale ou de la résurrection d'un répertoire injustement oublié.",
  ...
  rack: {
    review: "Les pièces réunies ici vont de la ligne soliste à l'écriture pour grand ensemble et pour chœur, chacune versée au catalogue à mesure qu'elle est achevée. Voici le registre courant ; le fonds complet est plus vaste.",
    dept: "Les Arts · Critique",
    headline: "Le compositeur dévoile une saison d'œuvres nouvelles",
    deck: "Compositions choisies pour solistes, ensembles, chœur et orchestre — versées au catalogue.",
...
const de: Dict = {
  ...
  front: {
    ...
    motto: "Alle Musik, die zu drucken sich lohnt.",
    leadPhoto: "Leitfoto",
  ...
  about: {
    ...
    bio3: "Im Libanon geboren, verließ er das Land mit siebzehn für Physik und Mathematik — erst in Frankreich, dann in Belgien — ehe er 2026 die Wissenschaften ganz für die Musik aufgab. Heute studiert er Komposition an der Sorbonne in Paris.",
    bio5: "Physik und Musik erschienen ihm nie als Gegensätze: beide verlangen, eine Struktur zu hören, ehe man sie beweisen kann, und die Disziplin der einen nährte jahrelang die andere, bevor er sich entschied.",
    bio6: "Sein Schreiben reicht von der Solostimme bis zu großen Ensemble- und Chorsätzen, und die Stunden, die nicht den eigenen Partituren gehören, gelten der Archivarbeit, die zu einer zweiten Berufung geworden ist.",
  ...
  services: {
    lede: "Das meiste, was diesen Schreibtisch erreicht, ist Zusammenarbeit: ein Dirigent, der ein Programm füllen will, ein Ensemble zwischen zwei Aufträgen, ein Verlag mit einem Manuskript, das eine saubere Ausgabe braucht. Die folgenden Leistungen verstehen sich in diesem Sinne — praktisch, auf Bestellung und um die Menschen herum gedacht, die sie aufführen werden.",
    dept: "Anzeigen",
    headline: "Der Komponist bietet seine Dienste an",
    deck: "Auftragswerke, Notensatz, Orchestrierung und Unterricht — zur Verfügung von Interpreten und Institutionen.",
  ...
  contact: {
    ...
    deck: "Der Schreibtisch steht Interpreten, Ensembles und Institutionen offen — und einfach Neugierigen.",
    byline: "Aus der Redaktion",
    title: "Kontakt",
    eyebrow: "Ein Wort des Komponisten",
    salutation: "Liebe Leserin, lieber Leser,",
    p1: "Ich höre stets gern von Interpreten, Ensembles und Institutionen, die neue Werke suchen — sei es eine eigens geschriebene Partitur oder die Wiederbelebung zu Unrecht vergessener Musik.",
  ...
  rack: {
    review: "Die hier versammelten Stücke reichen von der Solostimme bis zum großen Ensemble- und Chorsatz, jedes dem Katalog hinzugefügt, sobald es fertig ist. Es folgt das laufende Verzeichnis; der vollständige Bestand ist umfangreicher.",
    dept: "Feuilleton · Kritik",
    headline: "Der Komponist stellt eine Reihe neuer Werke vor",
    deck: "Ausgewählte Kompositionen für Solisten, Kammerbesetzungen, Chor und Orchester — zu den Akten gelegt.",
