...
const en = {
  ...
  about: {
    ...
    deck: "A self-taught Lebanese composer who abandoned physics to write the classical forms he learned from the scores alone.",
  ...
  book: {
    ...
    p4: "The aim behind all of it is plain: that her music circulate again, and find the performers it never reached.",
...
const fr: Dict = {
  ...
  about: {
    ...
    deck: "Compositeur libanais autodidacte, il a quitté la physique pour écrire les formes classiques, apprises des seules partitions.",
  ...
  book: {
    ...
    p4: "L'intention est simple : que sa musique circule de nouveau et retrouve les interprètes qu'elle n'a jamais atteints.",
...
const de: Dict = {
  ...
  about: {
    ...
    deck: "Ein autodidaktischer libanesischer Komponist, der die Physik aufgab, um die klassischen Formen zu schreiben, die er sich allein aus Partituren erarbeitete.",
  ...
  book: {
    ...
    p4: "Die Absicht dahinter ist schlicht: dass ihre Musik wieder erklingt und die Interpreten findet, die sie nie erreicht hat.",
